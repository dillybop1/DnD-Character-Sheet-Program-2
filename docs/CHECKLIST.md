...
| M3-02 | in_progress | M3 | Link sheet and builder surfaces into the richer compendium so rules references open from character context | M3-01, M6-01 | `npm run dev && npm run typecheck` | Core sheet/resource surfaces can open matching compendium entries without leaving the character workflow blind |
